...
actual object PlatformDownloader {
    actual suspend fun performDownload(
        ...
        throw NotImplementedError("Web downloads not yet implemented. Use browser download or Service Worker caching.")
    }
    ...
    actual fun getDownloadsDirectory(): String {
        throw NotImplementedError("Web storage not yet implemented")
    }
}
